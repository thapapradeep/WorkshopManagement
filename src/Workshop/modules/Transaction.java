...
@NamedQueries({
    ...
    , @NamedQuery(name = "Transaction.findByTypeId", query = "SELECT t FROM Transaction t WHERE t.typeId = :typeId")
...
public class Transaction implements Serializable {
    ...
    public Transaction(Integer id, Date date, String type, int typeId, float amount, String status) {
        this.id = id;
        this.date = date;
        this.type = type;
        this.typeId = typeId;
    ...
    public String toString() {
        return "Workshop.modules.Transaction[ id=" + id + " ]";
    }
